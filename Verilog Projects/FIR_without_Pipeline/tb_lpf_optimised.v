...
lpf_optimised #(.TAPS_OPP(TAPS_OPP)) dut1 (
    .clk(clk),
    .rst(rst),
    .x_in(x_in1),
    .y_out(y_out1)
...
lpf_optimised #(.TAPS_OPP(TAPS_OPP)) dut2 (
    .clk(clk),
    .rst(rst),
    .x_in(x_in2),
    .y_out(y_out2)
...
lpf_optimised #(.TAPS_OPP(TAPS_OPP)) dut3 (
    .clk(clk),
    .rst(rst),
    .x_in(x_in3),
    .y_out(y_out3)
...
initial begin
    ...
    outfile1 = $fopen("output_optimised_1.mem","w");
    outfile2 = $fopen("output_optimised_2.mem","w");
    outfile3 = $fopen("output_optimised_3.mem","w");
